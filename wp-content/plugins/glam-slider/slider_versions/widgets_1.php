<?php
class Glam_Slider_Simple_Widget extends WP_Widget {
	function Glam_Slider_Simple_Widget() {
		$widget_options = array('classname' => 'glam_slider_wclass', 'description' => 'Insert Glam Slider' );
		$this->WP_Widget('glam_sslider_wid', 'Glam Slider - Simple', $widget_options);
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("Glam_Slider_Simple_Widget");') );

//Category Widget
class Glam_Slider_Category_Widget extends WP_Widget {
	function Glam_Slider_Category_Widget() {
		$widget_options = array('classname' => 'glam_sliderc_wclass', 'description' => 'Glam Category Slider' );
		$this->WP_Widget('glam_ssliderc_wid', 'Glam Slider - Category', $widget_options);
	}
	...
	function widget($args, $instance) {
		...
		if ( ! empty( $title ) ) echo $before_title . $title . $after_title;
		 get_glam_slider_category($cat,$set,$offset='0',$sldr_title);
		echo $after_widget;
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("Glam_Slider_Category_Widget");') );

//Recent Posts Widget
class Glam_Slider_Recent_Widget extends WP_Widget {
	function Glam_Slider_Recent_Widget() {
		$widget_options = array('classname' => 'glam_sliderr_wclass', 'description' => 'Glam Recent Posts Slider' );
		$this->WP_Widget('glam_ssliderr_wid', 'Glam Slider - Recent Posts', $widget_options);
	}
	...
	function widget($args, $instance) {
		...
		if ( ! empty( $title ) ) echo $before_title . $title . $after_title;
		 get_glam_slider_recent($set,$offset='0',$sldr_title);
		echo $after_widget;
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("Glam_Slider_Recent_Widget");') );
?>