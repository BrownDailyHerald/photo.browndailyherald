<?php
/*
Template Name Posts: Featured Photo Template (with gallery)
*/
?>
<?php get_header(); ?>
...
?>
			<div class="post-cover">
				<a href="<?php echo $image_attributes[0]; ?>" title="<?php echo esc_attr($title_attr); ?>" rel="post-featured-image"><?php echo wp_get_attachment_image(get_post_thumbnail_id(), 'singlepost'); ?></a>
